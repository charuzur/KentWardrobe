...
# 2. Prerequisites
        ...
        Database Connection: We are using Option A: Shared Cloud Method. Please message the owner of this project directly to get the active database credentials and to ensure the TiDB cluster is active before you begin testing.
